  ...
  return (
    <section className="w-full bg-white py-12 px-4 sm:py-16 sm:px-6 max-w-5xl mx-auto">
      <div className="max-w-[1700px] mx-auto">
        ...
        <div className="font-inter text-[16px] md:text-[18px] text-[#4A5565] mb-8">
          The DSAA Computational Intelligence Society (CIS) offers travel grants to support members presenting their papers in-person at DSAA 2026.
        </div>
        ...
        <div className="border border-[#D1D5DB] rounded-xl p-6 md:p-8 mb-6">
          ...
          <ul className="font-inter text-[15px] md:text-[16px] text-[#232B3A] list-disc pl-5 space-y-2">
            <li>
              <strong>DSAA CIS Conference Travel Grant for Students</strong> — supports DSAA CIS Student Members to attend CIS conferences and present their accepted papers.
            </li>
            <li>
              <strong>DSAA CIS Conference Travel Grant for Researchers from Developing Countries</strong> — available for DSAA CIS Members (above Student grade) from developing countries to attend CIS conferences and present their papers.
            </li>
            <li>
              <strong>DSAA CIS “Industry Early Career” Travel Grant</strong> — supports DSAA CIS Members working in industry within 2 years of graduation to attend CIS conferences and present their papers.
            </li>
            <li>
              <strong>DSAA CIS “Conference Participation and Travel Grant”</strong> — waives or discounts the student early registration fee for non-lead Student Authors and Non-Author Students attending CIS conferences.
            </li>
          </ul>
        </div>
        ...
        <div className="border border-[#D1D5DB] rounded-xl p-6 md:p-8 mb-6">
          ...
          <ul className="font-inter text-[15px] md:text-[16px] text-[#232B3A] list-disc pl-5 space-y-2">
            ...
            <li>
              ...
              >DSAA CIS Conference Participation and Travel Grants</Link> (see DSAA CIS for the official form).
            </li>
        ...
        <div className="border border-[#D1D5DB] rounded-xl p-6 md:p-8 mb-6">
          <h3 className="font-inter font-semibold text-[20px] md:text-[24px] text-[#232B3A] mb-3">How to Become an DSAA CIS Member</h3>
          <ul className="font-inter text-[15px] md:text-[16px] text-[#232B3A] list-disc pl-5 space-y-2">
            <li>
              <Link
                href="https://www.DSAA.org/membership-catalog/productdetail/showProductDetailPage.html?product=MEMDSAA500"
                target="_blank"
                rel="noreferrer noopener"
                className="text-sky-500 hover:underline"
              >
            ...
            <li>
              <Link
                href="https://www.DSAA.org/membership-catalog/productdetail/showProductDetailPage.html?product=MEMCIS011"
                target="_blank"
                rel="noreferrer noopener"
                className="text-sky-500 hover:underline"
              >
                Join DSAA Computational Intelligence Society (CIS)
              </Link>
            </li>
          </ul>
        </div>
