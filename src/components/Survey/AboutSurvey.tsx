    ...
    return (
      <section className="w-full bg-white py-12 px-4 sm:py-16 sm:px-6 max-w-5xl mx-auto">
        <div className="max-w-[1700px] mx-auto">
          ...
          Call for Paper – Survey and Vision Track
          </h2>
          {/* <div className="font-inter text-[16px] md:text-[18px] text-center text-[#4A5565] mb-8">
            Important deadlines and milestones for DSAA 2026 Survey and Vision Track. Mark your calendar and stay updated.
          </div> */}
          ...
          <div className="border border-[#D1D5DB] rounded-xl p-6 md:p-8 mb-6">
            ...
            <ul className="font-inter text-[15px] md:text-[16px] text-[#232B3A] list-disc pl-5 mb-4 space-y-1">
              <li>Survey and review papers</li>
              <li>Vision and position papers</li>
              <li>Expert opinion and perspective papers</li>
              <li>Evaluation and reflection papers</li>
            </ul>
    ...
    > IEEE Proceedings Author Guidelines.</a></li>
          ...
          <div className="border border-[#D1D5DB] rounded-xl p-6 md:p-8 mb-6">
            ...
            <ul className="font-inter text-[15px] md:text-[16px] text-[#232B3A] list-disc pl-5 space-y-1">
              ...
              <li>Erol Gelenbe, Institute of Theoretical and Applied Informatics, Polish Academy of Sciences, Poland</li>
