  ...
  return (
    <section className="w-full bg-white py-12 px-4 sm:py-16 sm:px-6">
      <div className="max-w-[1700px] mx-auto">
        ...
        <div className="font-inter text-[16px] md:text-[18px] text-center text-[#4A5565] mb-8">All accepted papers will be presented as talks at the conference and included in the proceedings upon registration of at least one author and presentation of the paper at the conference.</div>
