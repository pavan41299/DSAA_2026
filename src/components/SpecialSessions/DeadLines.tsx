...
const deadlines = [
	{
		...
		title: "Special Session Proposals Due",
		subtitle: "",
	...
	},
	{
		...
		title: "Special Session Proposals Notification",
		subtitle: "",
		date: "To be announced",
		color: "#155DFC",
		border: "border-[#155DFC]",
	...
	},
	{
		...
		title: "Full-length Special Session Paper Submission",
	...
	{
		icon: <AlertCircle className="text-[#FF3B3B] w-6 h-6" />,
		title: "Short Special Session Paper Submission",
	...
	{
		icon: <Clock className="text-[#155DFC] w-6 h-6" />,
		title: "Special Session Paper Notification",
		subtitle: "",
		date: "To be announced",
		color: "#155DFC",
		border: "border-[#155DFC]",
	...
	{
		icon: <Calendar className="text-[#A259FF] w-6 h-6" />,
		title: "Special Session Paper Camera-Ready",
		subtitle: "",
		date: "To be announced",
		color: "#A259FF",
		border: "border-[#155DFC]",
