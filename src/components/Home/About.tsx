  ...
  return (
    <section className="max-w-[1600px] py-10 px-4 sm:py-14 sm:px-8 bg-white mx-auto">
      <div className="mx-auto text-center">
        <h2 className="font-inter font-semibold text-[32px] sm:text-[40px] md:text-[40px] leading-[110%] sm:leading-[100%] tracking-[0%] text-center align-middle text-black mb-6 sm:mb-10">
        ...
        <p className="font-inter text-black text-justify font-medium text-[16px] sm:text-[16px] md:text-[16px] leading-[24px] sm:leading-[28px] md:leading-[32.05px] text-[#777D86] tracking-[0%] max-w-5xl mx-auto">
          ...
          Analytics (DSAA) will be held in Aerocity, New Delhi, India on
          October 6-9, 2026.
        </p>
        <p className="font-inter text-black text-justify font-medium text-[16px] sm:text-[16px] md:text-[16px] leading-[24px] sm:leading-[28px] md:leading-[32.05px] text-[#777D86] tracking-[0%] max-w-5xl mx-auto">
